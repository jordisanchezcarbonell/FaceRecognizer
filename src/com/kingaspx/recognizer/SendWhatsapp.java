...
public class SendWhatsapp extends javax.swing.JDialog {
    ...
    private void kButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton3ActionPerformed
       // inserir();
        try {
            dispose();
            String url = "https://api.whatsapp.com/send?phone=34" + tel.replace(" ", "").replace("(", "").replace(")", "").replace("-", "") + "&text=" + text_lbl.getText().replace(" ", "%20"); //Brazil code
            https://www.loom.com/share/0655a39e627a4d2484f9978b034cc79f
