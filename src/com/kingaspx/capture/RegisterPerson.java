...
public class RegisterPerson extends javax.swing.JDialog {
    ...
    org.bytedeco.javacpp.opencv_objdetect.CascadeClassifier cascade = new org.bytedeco.javacpp.opencv_objdetect.CascadeClassifier("C:\\Users\\jordi\\Desktop\\photos\\opencv-master\\data\\haarcascades\\haarcascade_frontalface_alt.xml");
...
//                                        nome do arquivo: idpessoa + a contagem de fotos. ex: person.10(id).6(sexta foto).jpg
                                            String cropped = "C:\\Users\\jordi\\Desktop\\photos\\person." + txt_id_label.getText() + "." + sample + ".jpg";
    ...
    public void generate() {
        File directory = new File("C:\\Users\\jordi\\Desktop\\photos\\");
        ...
        lbph.save("C:\\Users\\jordi\\Desktop\\photos\\classifierLBPH.yml");
    }
